...
- `RPi5_main` Issue #435 / PR #436 is merged and adds the capability-specific trusted Weather host-wiring/helper source bridge with fixed stage/helper identities and whole-pactivation-envelope binding.
