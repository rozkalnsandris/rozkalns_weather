...
class IngestOrchestrator:
    ...
    def _ensure_locations(self) -> None:
        # Keep the old WMO/MOSMIX reference identity intact for compatibility.
        ...
        # New measured public verification is co-located at the pinned DWD CDC
        # benchmark station. This write happens only when ingest itself runs.
    ...
    def collect_weathernext(self, *, now: datetime | None = None, adapter: WeatherNextBigQueryAdapter | None = None) -> dict[str, object]:
        ...
        # WeatherNext/private activation is outside #155; retain the existing
        # reference identity instead of expanding private scope here.
