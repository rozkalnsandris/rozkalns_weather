...
class Settings:
    ...
    def from_env(cls, env: dict[str, str] | None = None) -> "Settings":
        ...
        threshold = _float("PRECIP_EVENT_THRESHOLD_MM", source.get("PRECIP_EVENT_THRESHOLD_MM"), DEFAULT_PRECIP_EVENT_THRESHOLD_MM)
        ...
        return cls(home_lat=lat, home_lon=lon, home_timezone=source.get("HOME_TIMEZONE", "Europe/Berlin"), home_label=source.get("HOME_LABEL", "Dortmund-Wickede"), google_cloud_project=source.get("GOOGLE_CLOUD_PROJECT") or None, weathernext_bigquery_dataset=source.get("WEATHERNEXT_BIGQUERY_DATASET") or None, database_url=source.get("DATABASE_URL", "sqlite:///data/weather.db"), ingest_timeout_seconds=timeout, ingest_retries=retries, precipitation_event_threshold_mm=threshold)
