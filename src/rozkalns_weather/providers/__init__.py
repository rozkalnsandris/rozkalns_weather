...
PROVIDERS = (
    ...
    ProviderDescriptor(id="dwd_observations", model_provider="DWD", model_name="Observations", role="verification_truth", transport="DWD CDC Open Data", station_id="05480"),
