...
- Weather's stricter FAST merge gate, explicit AUTO-RUN FULL activation, LIVE/STRICT boundary, production SQLite/corpus gate, privacy/provenance rules and DWD warning authority remain unchanged.
